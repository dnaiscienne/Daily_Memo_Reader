...
public class EntryDetailActivity extends ActionBarActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPager.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                mSelectedItemId = mCursor.getLong(EntryLoader.Query._ID);
        ...
        if (savedInstanceState == null) {
            if (getIntent() != null && getIntent().getData() != null) {
                mStartId = EntriesContract.Entries.getEntryId(getIntent().getData());
    ...
    public void onLoadFinished(Loader<Cursor> cursorLoader, Cursor cursor) {
        ...
        if (mStartId > 0) {
            ...
            while (!mCursor.isAfterLast()) {
                if (mCursor.getLong(EntryLoader.Query._ID) == mStartId) {
    ...
    public void onUpButtonFloorChanged(long itemId, EntryDetailFragment fragment) {
    ...
    private class MyPagerAdapter extends FragmentStatePagerAdapter {
        ...
        public Fragment getItem(int position) {
            mCursor.moveToPosition(position);
            return EntryDetailFragment.newInstance(mCursor.getLong(EntryLoader.Query._ID));
        }
